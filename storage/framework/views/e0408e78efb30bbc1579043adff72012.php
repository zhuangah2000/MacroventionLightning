                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><span><?php echo app('translator')->get('translation.material-design'); ?></span><span
                                        class="badge badge-pill bg-info">v3.5</span></a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH D:\GitHubRepo\Lightning\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>