...
@section('content')
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="apps-projects-create" class="btn btn-secondary"><i class="ri-add-line align-bottom me-1"></i> Add
                    New</a>
            </div>
        </div>
        <div class="col-sm">
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-03.jpg') }}" alt="" class="object-fit-cover card-img-top"
                    height="120">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-05.jpg') }}" alt="" class="object-fit-cover card-img-top"
                    height="120">
                <div class="card-body text-center">
                    <img src="{{ URL::asset('build/images/nft/img-06.jpg') }}" alt=""
                        class="avatar-md rounded-circle object-fit-cover mt-n5 img-thumbnail border-light mx-auto d-block">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-06.jpg') }}" alt="" class="object-fit-cover card-img-top"
                    height="120">
                <div class="card-body text-center">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-01.jpg') }}" alt="" class="object-fit-cover card-img-top"
                    height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                        class="avatar-md rounded-circle object-fit-cover mt-n5 img-thumbnail border-light mx-auto d-block">
