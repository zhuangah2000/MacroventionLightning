...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="apps-nft-explore" class="btn btn-soft-secondary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="explore-place-bid-img overflow-hidden rounded">
                        ...
                        <div class="place-bid-btn">
                            <a href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place Bid</a>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-reset">Patterns Arts &
                                Culture</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-reset">Evolved
                                Reality</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-body">Long-tailed
                                Macaque</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-body">Robotic Body
                                Art</a></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card explore-box">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details" class="text-body">Creative Filtered
                                Portrait</a></h6>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="apps-nft-creators" class="btn btn-soft-secondary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Trendy Fashion
                            Portraits</a></h5>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Smillevers Crypto</a>
                    </h5>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Evolved Reality</a>
                    </h5>
        ...
        <div class="col">
            <div class="card explore-box card-animate">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-1 fs-16"><a href="apps-nft-item-details" class="text-body">Abstract Face
                            Painting</a></h5>
    ...
    <div class="row row-cols-xl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-03.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-01.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-05.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
        ...
        <div class="col">
            <div class="card">
                <img src="{{ URL::asset('build/images/nft/img-02.jpg') }}" alt="" class="card-img-top object-fit-cover"
                    height="120">
                <div class="card-body text-center">
                    <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
