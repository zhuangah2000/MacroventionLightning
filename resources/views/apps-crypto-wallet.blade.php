                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            ...
                                            <a href="javascript:void(0)" class="currency_name text-reset">Bitcoin
                                                (BTC)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/eth.svg') }}"
                                                alt="" class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name text-reset">Ethereum
                                                (ETH)</a>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/ltc.svg') }}"
                                                alt="" class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name text-reset">Litecoin
                                                (LTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="{{ URL::asset('build/images/svg/crypto-icons/yfi.svg') }}"
                                                alt="" class="avatar-xxs me-2" />
                                            <a href="javascript:void(0)" class="currency_name text-reset">Yearn.finance
                                                (YFI)</a>
                                        </div>
                                    </td>
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <a href="apps-crypto-transactions" class="btn btn-soft-secondary w-100">View All Transactions
