                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <span class="badge bg-secondary me-1">1,958</span> <span class="text-muted">Paid by
                                clients</span>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-light rounded fs-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <span class="badge bg-secondary me-1">338</span> <span class="text-muted">Unpaid by
                                clients</span>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-light rounded fs-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            ...
                            <span class="badge bg-secondary me-1">502</span> <span class="text-muted">Cancelled by
                                clients</span>
                        </div>
                        <div class="avatar-sm flex-shrink-0">
                            <span class="avatar-title bg-light rounded fs-3">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="apps-invoices-create" class="btn btn-secondary"><i
