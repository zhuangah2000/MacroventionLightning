                            ...
                            <div class="gallery-light">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-7.jpg') }}"
                                                    title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-8.jpg') }}"
                                                    title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-9.jpg') }}"
                                                    title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-11.jpg') }}"
                                                    title="">
                                                    <img class="gallery-img img-fluid mx-auto"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6">
                                        <div class="gallery-box card">
                                            <div class="gallery-container">
                                                <a class="image-popup" href="{{ URL::asset('build/images/small/img-12.jpg') }}"
                                                    title="">
                                                    <img class="gallery-img img-fluid mx-auto"
