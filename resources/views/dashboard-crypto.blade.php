            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div id="portfolio_donut_charts"
                        data-colors='["--vz-primary", "--vz-secondary", "--vz-info", "--vz-success"]' class="apex-charts"
                        dir="ltr"></div>
                        ...
                        <li class="list-group-item px-0">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    ...
                                    <p class="fs-12 mb-0 text-muted"><i
                                            class="mdi mdi-circle fs-10 align-middle text-secondary me-1"></i>LTC </p>
                                </div>
                                <div class="flex-shrink-0 text-end">
                    ...
                    <div class="tab-content p-0">
                        <div class="tab-pane active" id="buy-tab" role="tabpanel">
                            <div class="p-3 bg-success-subtle">
                                <div class="float-end ms-2">
                                    <h6 class="text-success mb-0">USD Balance : <span class="text-body">$12,426.07</span>
                                    </h6>
                                </div>
                        ...
                        <div class="tab-pane" id="sell-tab" role="tabpanel">
                            <div class="p-3 bg-danger-subtle">
                                <div class="float-end ms-2">
                                    <h6 class="text-danger mb-0">USD Balance : <span class="text-body">$12,426.07</span>
                                    </h6>
                                </div>
