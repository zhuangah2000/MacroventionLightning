                        ...
                        <div class="col-lg-8 col-sm-10">
                            <div class="text-center">
                                <h1 class="display-4 fw-medium mb-4 lh-base text-white">Discover Digital Art & Collect <span
                                        class="text-secondary">NFT Marketplace</span></h1>
                                ...
                                <div class="hstack gap-2 justify-content-center">
                                    ...
                                    <a href="apps-nft-explore" class="btn btn-secondary">Explore Now <i
                                            class="ri-arrow-right-line align-middle ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 product-item crypto-card 3d-style">
                            <div class="card explore-box card-animate">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-1"><a href="apps-nft-item-details">Abstract Face Painting</a>
                                    </h5>
                        ...
                        <div class="col-lg-3">
                            <div class="card shadow-none">
                                <div class="card-body">
                                    ...
                                    <a href="#!" class="link-secondary">Read More <i
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details">Evolved Reality</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card explore-box card-animate border">
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <h6 class="fs-16 mb-0"><a href="apps-nft-item-details">Long-tailed
                                                macaque</a></h6>
                                    </div>
                                </div>
                            </div>
