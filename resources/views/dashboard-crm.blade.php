            ...
            <div class="card crm-widget">
                <div class="card-body p-0">
                    <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                        <div class="col">
                            <div class="py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13 mb-3">Campaign Sent <i
                        ...
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13 mb-3">Annual Profit <i
                                        class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="col">
                            <div class="mt-3 mt-md-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13 mb-3">Lead Conversation <i
                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13 mb-3">Daily Average Income <i
                                        class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <div class="col">
                            <div class="mt-3 mt-lg-0 py-4 px-3">
                                <h5 class="text-muted text-uppercase fs-13 mb-3">Annual Deals <i
                                        class="ri-arrow-down-circle-line text-danger fs-18 float-end align-middle"></i></h5>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
    ...
    <div class="row">
        <div class="col-xxl-3 col-md-6">
            <div class="card">
                ...
                <div class="card-body pb-0">
                    <div id="sales-forecast-chart" data-colors='["--vz-primary", "--vz-success", "--vz-secondary"]'
        ...
        <div class="col-xxl-3 col-md-6">
            <div class="card card-height-100">
                ...
                <div class="card-body pb-0">
                    <div id="deal-type-charts" data-colors='["--vz-secondary", "--vz-info", "--vz-success"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col -->
                ...
                <div class="card-body px-0">
                    <ul class="list-inline main-chart text-center mb-0">
                        <li class="list-inline-item chart-border-left me-0 border-0">
                            <h5 class="text-primary">$584k <span
                                    class="text-muted d-inline-block fs-13 align-middle ms-2">Revenue</span></h5>
                        </li>
                        <li class="list-inline-item chart-border-left me-0">
                            <h5>$497k<span class="text-muted d-inline-block fs-13 align-middle ms-2">Expenses</span></h5>
                        </li>
                        <li class="list-inline-item chart-border-left me-0">
                            <h5><span data-plugin="counterup">3.6</span>%<span
                                    class="text-muted d-inline-block fs-13 align-middle ms-2">Profit Ratio</span></h5>
                        </li>
                    </ul>
