    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="distributed_treemap"
                        data-colors='["--vz-primary", "--vz-primary-rgb, 0.65", "--vz-secondary", "--vz-secondary-rgb, 0.75","--vz-primary-rgb, 0.4", "--vz-success"]'
        ...
        <div class="col-xl-4">
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    <div id="user_device_pie_charts" data-colors='["--vz-primary", "--vz-secondary", "--vz-success"]'
                        class="apex-charts" dir="ltr"></div>
        ...
        <div class="col-xxl-4 col-md-6">
            <div class="card card-height-100">
                ...
                <div class="card-body pb-0">
                    <div id="deal-type-charts" data-colors='["--vz-primary", "--vz-secondary"]' class="apex-charts"
                        dir="ltr"></div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col -->
