                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<span class="counter-value" data-target="243"></span><small
                                    class="text-muted fs-13">.10k</small></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<span class="counter-value" data-target="658"></span><small
                                    class="text-muted fs-13">.00k</small></h4>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<span class="counter-value" data-target="104"></span><small
                                    class="text-muted fs-13">.85k</small></h4>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0">$<span class="counter-value" data-target="87"></span><small
                                    class="text-muted fs-13">.35k</small></h4>
                        </div>
                        <div class="flex-shrink-0 avatar-sm">
